...
//	 @Test
//	 public Karate runVariabletest() {
//		 return Karate.run("classpath:com/apiFeatures/Variable.feature").relativeTo(getClass());
//	 }
	 
	 @Test
	 public Karate runVariabletest() {
		 return Karate.run("classpath:com/apiFeatures/VariableByFile.feature").relativeTo(getClass());
	 }
